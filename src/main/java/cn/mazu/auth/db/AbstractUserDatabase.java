 ...
 * @see User
 */
public abstract class AbstractUserDatabase extends Database{

	private static Logger logger = LoggerFactory
			.getLogger(AbstractUserDatabase.class);

	public AbstractUserDatabase(EntityManager entityManager) {
		super(entityManager);
...
//	}
	...
	/*public void setIdentity(User user, String provider, String id) {
		...
		System.out.println("abstract-removeafter:"+user.isValid());
...
//	public abstract void removeIdentity(User user, String provider);
	...
	*//**
	...
	public boolean setName(User user, String name){
		logger.error(new StringWriter().append(new Require("setName", NAME_VERIFICATION).toString()).toString());
		return false;
	}
	public boolean setGender(User user, String sex){
		logger.error(new StringWriter().append(new Require("setGender", GENDER_VERIFICATION).toString()).toString());
		return false;
	}
	public boolean setBirth(User user, Date date){
		logger.error(new StringWriter().append(new Require("setBirth", BIRTH_VERIFICATION).toString()).toString());
		return false;
	}
	public boolean setCompany(User user, String company){
		logger.error(new StringWriter().append(new Require("setCompany", COMPANY_VERIFICATION).toString()).toString());
		return false;
	}
	
	public boolean setTel(User user, String tel){
		logger.error(new StringWriter().append(new Require("setTel", TEL_VERIFICATION).toString()).toString());
		return false;
	}
