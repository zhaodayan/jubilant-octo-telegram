...
@Entity
@Table(name="AuthInfo")
public class AuthInfo extends EntityObject{
	public AuthInfo() {
	...
	*//**
	 ...
	 *//*
	@OneToMany(cascade={CascadeType.REFRESH,CascadeType.PERSIST},mappedBy="authInfo",fetch=FetchType.LAZY)
	@OrderBy("id")
	...
	*//**
	 ...
	 *//*
	@OneToMany(cascade={CascadeType.REFRESH,CascadeType.PERSIST},mappedBy="authInfo",fetch=FetchType.EAGER)
	@OrderBy("id")
