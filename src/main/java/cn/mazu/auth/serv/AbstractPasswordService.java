...
public interface AbstractPasswordService {
	 ...
	 */
	public static abstract class AbstractStrengthValidator extends Validator {
		private static Logger logger = LoggerFactory
		 ...
		 * password validation.
		 */
		public Validator.Result validate(String password, String loginName,
				String email) {
			...
			return new Validator.Result(
					result.isValid() ? Validator.State.Valid
							: Validator.State.Invalid, result.getMessage());
		}
		 ...
		 */
		public Validator.Result validate(String password) {
