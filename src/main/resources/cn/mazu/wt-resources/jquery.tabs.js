...
//       cc[0].appendChild(pp[0]);
        ...
        cc.children("div.tabs-panels").children("div").each(function(i) {
        	var _this = $(this).children("div")[0];
            var _26 = $.extend({}, $.parser.parseOptions(_this), {
                selected: ($(_this).attr("selected") ? true : undefined)
            });
            var pp = $(_this);
            _25.push(pp);
            _35(_24, pp, _26);
    ...
    function _3b(_3c, _3d) {
        ...
        _3f.push(pp);
        _35(_3c, pp, _3d);
        _3e.onAdd.call(_3c, _3d.title, _3f.length);
        _12(_3c);
        if (_3d.selected) {
            _40(_3c, _3f.length);
        }
    ...
    function _4b(_4c, _4d) {
        ...
        var _54 = _4a(_4c, tab); //index
        if (_4e.onBeforeClose.call(_4c, _53, _54) == false) {
            return;
        }
        //----------------
        var _55 = _50.pop();
        if (tab.hasClass('tabs-selected') && tab.index == tabs.length) {
            hisTitle = _53;
        }
        //------------------
    ...
    function _40(_62, _63) {
        ...
        $("#" + _6b + "seltab").click(); //added by zhaoj
    };
